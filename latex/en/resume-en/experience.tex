  ...
  \cventry
    ...
    {Feb. 2025 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Backend Engineer, outsourced to HSBC Bank, a leading global financial institution, via Meitai Technology Service (Shanghai) Co., Ltd. Guangzhou Branch (a subsidiary of TEKsystems and Allegis Group, Inc.).}
        \item {Responsible for developing and optimizing backend systems within HSBC's Enterprise Technology Department, specifically for the Finance Transformation Platform. This role required strong business knowledge of accounting (Ledger) and financial reporting. Maintained code for importing, validating, exporting, and listing financial data, and adjusted submission and approval procedures for new types of financial headers.}
        \item {Involved in the whole lifecycle of feature development, from local testing, UAT testing, and production releasing. My responsibilities ranged from investigating deadlock reasons to resolving IBM DB2 stored procedure calling issues, fixing data or code logic reported by the testing team, heavily utilizing Copilot, and writing Python scripts to help testing and beyond. Organized and posted over one hundred technology documents or tool guides, some of which caught the attention of the team and helped them solve same problems.}
        \item {This role utilized technologies such as Java, Spring Boot, IBM DB2, multithreading, networking, Maven, Nexus, Angular, Python, and development tools/environments including Windows, Control-M, IBM WebSphere Application Server, and Copilot.}
      \end{cvitems}
    }
