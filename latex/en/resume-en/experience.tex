  ...
  \cventry
    ...
    {Feb. 2025 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item { Backend Engineer, outsourced to HSBC Bank (under TEKsystems/Allegis Group), developing and optimizing backend systems for the Finance Transformation Platform in HSBC’s Enterprise Technology Department.}
        \item { Maintained features for financial data processing (import, validation, export) and enhanced submission/approval workflows for new financial headers, leveraging strong knowledge of accounting, ledger, and banking systems.}
        \item { Managed the full development lifecycle, from local development and UAT testing to production releases. Troubleshot and resolved complex issues, including deadlocks and IBM DB2 stored procedure calling issues, and fixed data/code logic defects. Automated tasks with Python scripts and documented over 100 technical guides, with several becoming valuable references for team members facing similar challenges.}
        \item { Utilized technologies including Java, Spring Boot, IBM DB2, multithreading, Maven, Nexus, Angular, and Python, along with development tools and environments such as Windows, Control-M, IBM WebSphere Application Server, and Copilot.}
      \end{cvitems}
    }
