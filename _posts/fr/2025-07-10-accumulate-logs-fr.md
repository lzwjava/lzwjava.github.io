...
lang: fr
layout: post
title: Avantages de l'accumulation des journaux
translated: true
---
...
Parfois, lorsque je travaille sur des projets servant plusieurs régions, j'ajoute ce pays en suffixe, comme mutual-fund-cn-1.log, mutual-fund-sg-1.log.

Les noms de fichiers des journaux sont quelque peu informels. Parce qu'à cette époque, j'avais besoin de me concentrer sur les piles d'erreurs ou les appels de fonctions environnantes.
...
Ainsi, lorsque vous commencez une nouvelle tâche ou corrigez un nouveau bug, vous avez des centaines de journaux à votre disposition pour résoudre ce nouveau bug. Vous n'êtes pas seul.
...
Et lorsque je suis entré dans le monde plus formel de l'entreprise, le développement des projets était différent de mon projet personnel ou de mon projet de startup. Ils ont des environnements de test SIT, UAT. Et l'environnement de production est souvent ouvert à certains petits groupes de pairs. Obtenir les journaux d'eux et résoudre les problèmes devient long et quelque peu fastidieux. Et exécuter un projet prend du temps, et le pipeline Jenkins a souvent besoin de moitié d'heure pour s'exécuter.
