...
* Utilisez Gemini ou Grok pour générer des images de célébration de festival avec des invites comme "Générez une image de Nouvel An du Serpent Lunar joyeuse avec des noms de texte inclus".
...
* [Essai de llama.cpp](./llama-cpp-fr)

* [Un Cas d'Utilisation de la Recherche dans ChatGPT](./ai-search-fr)
