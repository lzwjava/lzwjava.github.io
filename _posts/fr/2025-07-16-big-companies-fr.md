...
Les grandes entreprises ressemblent beaucoup aux grands programmes. Pour une grande entreprise avec 100 000 employés et 100 000 sous-traitants, c'est comme un grand programme avec 200 000 méthodes.
...
Les grandes entreprises ont tant de procédures et de processus parce qu'elles ne font pas confiance à leurs employés ou sous-traitants. Elles doivent donc vérifier et contrôler beaucoup de choses.
...
Dans ma startup solo, j'ai juste besoin d'utiliser 1 minute pour déployer mon serveur backend et 5 minutes pour corriger un bug mineur et déployer. C'est direct et rapide. Pour les grandes entreprises, cela prend 1 semaine pour préparer la demande de déploiement, obtenir les approbations des managers, faire le déploiement avec l'équipe informatique et effectuer les vérifications de santé.
...
Pour corriger un bug mineur et déployer, cela prend deux semaines. Vous obtenez le ticket pour enquêter, faire l'analyse et les tests, puis la revue, fusionner le code, le signaler aux équipes de test pour qu'elles testent, puis déployer.
