...
* Persévérez à travers les difficultés en prenant des pauses et en cherchant l'inspiration auprès de vos pairs.

* Maintenez un engagement constant au lieu de compter sur des sessions de révision intensive.
...
* Souvenez-vous que l'apprentissage vient naturellement par le jeu et l'exploration.
...
* L'attitude ou la motivation est difficile à se mentir à soi-même. Suivez votre véritable passion.

* L'environnement est important. Vous n'avez pas besoin d'apprendre l'anglais difficilement si vous grandissez dans des pays anglophones.

* Votre cerveau est puissant. Réfléchissez aux choses par vous-même. Réfléchissez encore et encore, fois après fois.

* Saisissez l'essence ou le principe des choses à apprendre. Par exemple, l'apprentissage automatique concerne le calcul, et les startups concernent la création de quelque chose que les gens veulent.

* Vous n'avez pas besoin d'apprendre quelque chose pour prouver quelque chose aux autres. Les nouvelles découvertes prennent du temps pour devenir populaires. Vos capacités prennent du temps pour devenir vraiment bonnes. Les autres le remarqueront alors.

* L'apprentissage consiste principalement à essayer de nouvelles choses ou à penser de nouvelles façons. Continuez à explorer.
