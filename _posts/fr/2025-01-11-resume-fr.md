...
- Amateur de voyages et maître des road trips. Est allé aux États-Unis deux fois, ainsi qu'à Hong Kong et Macao, et dans la moitié de la Chine. A suivi des cours d'anglais en ligne avec 60 professeurs d'anglais philippins, et certains professeurs africains ou européens aussi.

## Expérience Professionnelle

### Meitai Technology Service (Shanghai) Co., Ltd. Guangzhou Branch, Ingénieur Backend, 2025.02 - Présent

- Ingénieur backend externalisé pour HSBC Bank sous TEKsystems, développant et optimisant les systèmes backend pour la plateforme de transformation financière du département Technology d'Enterprise de HSBC.
...
- A géré le cycle de développement complet, du développement local aux tests UAT et aux mises en production. Copilot a été largement utilisé pour des tâches étendues comme l'analyse des causes racines, la génération de scripts Python, et la documentation d'environ 200 guides techniques; certains de ces guides sont devenus des références clés pour les coéquipiers faisant face à des défis similaires.
...
- A analysé et réimplémenté certaines parties centrales autour de 30 projets d'exemple sur le machine learning, provenant de PyTorch, TensorFlow, cours en ligne Coursera ou autres projets open-source. A obtenu deux certificats de complétion de cours de Coursera sur la spécialisation Machine Learning et la spécialisation Deep Learning.
...
- Pendant la période de l'entreprise de conseil logiciel, j'ai complété 50 petits projets logiciels pour des clients, incluant des sites web, des jeux, et des applications. Le chiffre d'affaires était d'environ 3 millions RMB et le bénéfice d'environ 700 000 RMB. Responsable de la négociation de projets, de la gestion d'équipe, et de certains développements logiciels. Les projets notables sont présentés ci-dessous.
...
- Plateforme de Transformation Financière de HSBC (2025.02 - Présent) Participation au développement backend. Utilisation de stacks technologiques comme Java, Spring, Python, IBM WebSphere et Copilot.
...
- A postulé deux fois à Y Combinator. Une fois, est entré dans le deuxième tour avec environ un taux d'acceptation de 3%, bien qu'il n'ait pas été accepté dans la batch.
...
- A acquis beaucoup de pratique d'influence sur les réseaux sociaux, incluant le blogging, WeChat Subscription Channel, TikTok, WeChat Videos, Weibo et LinkedIn. A acquis des milliers d'abonnés dans plusieurs comptes ou 60k vues de pages par an.
