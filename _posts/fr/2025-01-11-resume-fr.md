...
- Chercheur autodidacte avec trois articles de style académique sur l'inversion de la myopie et la restauration de la vision naturelle, inspiré par les travaux de Yin Wang et Todd Becker, soutenu par trois ans d'expérimentation.
- Ingénieur avec un esprit entrepreneurial et un état d'esprit produit, utilisant 3 téléphones mobiles et mille applications et jeux pour s'amuser. Travaille comme un agent IA autonome, compétent avec de nombreux outils IA, et devient meilleur avec une journalisation et des tests complets.
...
- A rédigé et publié des blogs techniques pour partager des connaissances en ligne, amélioré sa maîtrise de l'anglais en s'engageant avec Netflix et la littérature, et renforcé ses compétences de résolution de problèmes en relevant environ 500 problèmes d'algorithmes et en participant à des compétitions Codeforces. A acquis une petite expérience pratique avec les technologies big data et cloud-native en explorant des tutoriels introductifs et en exécutant des exemples pour Spark, Hadoop, Kubernetes, et Docker.
...
- Du point de vue de l'ingénierie, j'ai effectué la majeure partie du développement logiciel, résultant en environ 2 000 commits de code à travers 3 applications clientes web et 1 serveur. Ils ont été open source sur GitHub@lzwjava quelques années plus tard. Le projet a exploité PHP, Vue, HTML, CodeIgniter, MySQL, Redis, LeanCloud, Alibaba Cloud, WeChat SDK, SRS (Simple Realtime Server), WeChat MiniProgram, Fabric, Linux, et Nginx. J'ai également fait un peu de design dans Sketch.
- Pendant la période de conseil logiciel, j'ai complété 50 petits projets logiciels pour des clients, incluant des sites web, des jeux, et des applications. Le chiffre d'affaires était d'environ 3 millions RMB et le bénéfice d'environ 700 000 RMB. Responsable de la négociation de projets, de la gestion d'équipe, et d'une partie du développement logiciel. Certains projets notables sont présentés ci-dessous.
...
- A participé au développement du SDK Objective-C et Java de LeanCloud. Responsable du développement du client iOS et Android de LeanChat, une application de chat conçue pour démontrer le SDK de messagerie instantanée. De plus, a travaillé sur divers projets frontend. A employé une stack technologique robuste, en utilisant des outils modernes tels que le SDK iOS, le SDK Android, Cocoapods, Xcode, Android Studio, et le framework Angular.
...
- Classé dans le top 1 dans la compétition d'entraînement mensuelle ACM/ICPC de mon école parmi environ 100 étudiants de haut niveau de l'université, y compris ceux de l'année supérieure.
...
- Fun Live (2016.6 - 2017.9) Responsable de la majeure partie du développement de code d'une plateforme de diffusion en direct de connaissances. Utilisation de stacks technologiques comme PHP, JavaScript, HTML, AliCloud, et RTMP Streaming.
...
- A fondé deux startups : une avec des cofondateurs, et une créée par moi-même. La dernière a gagné 30k utilisateurs et a une fois atteint un chiffre d'affaires de 3 millions CNY par an.
...
- En tant qu'utilisateur précoce de Blue Sky, j'ai commenté le premier post de Jeff Dean ici et j'ai reçu un like de lui ; il est le scientifique en chef de Google.
