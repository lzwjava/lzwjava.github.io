...
- Homme, né en 1995, citoyen chinois, résidant à Guangzhou. A atteint le top 300 au Guangdong NOIP 2011 et a résolu environ 1000 problèmes d'algorithmes en ligne.
...
- Ingénieur avec un esprit entrepreneurial et un état d'esprit produit, utilisant 3 téléphones mobiles et mille applications et jeux à essayer. Travaille comme un agent IA autonome, compétent avec de nombreux outils IA, et s'améliore grâce à une journalisation et des tests complets.
...
- A géré l'ensemble du cycle de développement, du développement local aux tests UAT et aux mises en production. Copilot a été largement utilisé pour des tâches étendues telles que l'analyse des causes profondes, la génération de scripts Python et la documentation d'environ 50 guides techniques; certains de ces guides sont devenus des références clés pour les coéquipiers confrontés à des défis similaires.
...
- A participé en tant que Développeur Full Stack à un projet de bot d'histoire alimenté par l'IA utilisant l'API de Claude pour des histoires personnalisées. Le bot prend en charge la configuration des prompts et inclut une page de gestion pour la configuration. Développé avec Python, Flask, React et Nginx, et déployé sur AWS. A utilisé Prometheus pour la surveillance, la pile ELK pour la gestion des logs, et ChatGPT-4 pour l'assistance en programmation.
- A maintenu un blog technique avec 431 publications originales. A utilisé des grands modèles de langage pour traduire le contenu dans 9 langues, fournir des audios de synthèse vocale, prendre en charge les formats PDF et EPUB, intégrer les workflows GitHub, et utiliser LaTeX pour rédiger des articles ou créer un CV. D'autres technologies employées incluent Python, Jekyll, Deepseek et Mistral. Le site web est https://lzwjava.github.io.
...
- Beyondsoft Consulting est une entreprise leader en conseil et TI d'entreprise. DBS Bank est la plus grande banque d'Asie du Sud-Est en termes d'actifs et parmi les plus grandes banques d'Asie. En contrat avec Beyondsoft, assigné pour travailler pour DBS Bank et a contribué aux projets DBS Client Connect et DBS DigiBank CN.
...
- A complété divers projets logiciels en tant que freelancer, développement de site web pour enseignes LED, intégration de WeChat Entreprise pour ShowMeBug, web scraper pour la collecte de données commerciales, outil eBook mathjax2mobi.
...
- Intégration de WeChat Entreprise pour ShowMeBug: A contribué à l'intégration de ShowMeBug avec WeChat Entreprise, permettant un accès fluide aux outils d'entretien technique au sein de l'écosystème WeChat Entreprise. A utilisé des technologies comme Ruby, Ruby On Rails, PostgreSQL et le SDK WeChat pour créer une expérience utilisateur fluide pour les interviewers et les candidats.
...
- Pendant la période de conseil logiciel, j'ai complété 50 petits projets logiciels pour des clients, incluant des sites web, des jeux et des applications. Le chiffre d'affaires était d'environ 3 millions de RMB et le bénéfice d'environ 700 000 RMB. Responsable de la négociation de projets, de la gestion d'équipe et d'une partie du développement logiciel. Certains projets notables sont présentés ci-dessous.
...
- Ma première tentative entrepreneuriale était avec 5 cofondateurs, qui m'ont beaucoup aidé avec mon propre startup et m'ont inspiré à m'améliorer. Nous venions de grandes entreprises ou de startups de pointe à Pékin. Ce n'est que plus tard dans la vie que j'ai pu apprécier l'esprit entrepreneurial à Pékin et la plus grande chance de rencontrer des personnes qui rêvent en grand et poursuivent l'excellence plutôt que de faire des emplois médiocres. L'atmosphère à Pékin à cette époque était assez unique et excitante.
...
- Classé dans le top 1 de la compétition de formation mensuelle ACM/ICPC de mon école parmi environ 100 meilleurs étudiants de l'université, y compris ceux de l'année supérieure.
- A remporté le troisième prix au concours de créativité des œuvres numériques "Jeunesse, Santé, Nouveaux Médias" organisé par l'UNESCO et l'Université de Communication de Chine pour l'œuvre numérique "Maman Timide de Dire".
...
- ShowMeBug (2021.7 - 2021.9) Responsable de l'intégration entre la plateforme et WeChat Entreprise, incluant la connexion et l'entrée facile à l'entretien. Utilisation de stacks technologiques comme Ruby on Rails, PostgreSQL et WeChat SDK.
...
- SDK LeanCloud et LeanChat (2014.07 - 2015.10) Responsable d'une partie du développement des SDK Objective-C et Java, et de l'ensemble du développement de leur application démonstration LeanChat.
...
Ci-dessous sont détaillés les outils qui m'aident à accumuler les compétences ci-dessus, ainsi que d'autres outils intéressants. J'utilise encore certains d'entre eux et je peux apprendre à utiliser les autres en quelques jours.
...
- Si les choses ou produits sont bon marché, très disposé à acheter différents modèles pour les comparer et comprendre leurs nuances.
