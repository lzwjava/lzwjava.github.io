...
- Partageur de connaissances généreux avec l'aide de l'IA pour corriger la grammaire, ayant environ 480 articles originaux sur le blog attirant environ 60 000 vues de pages par an, et qui documente beaucoup dans l'environnement d'entreprise aussi.
...
- Amoureux des voyages et maître des road trips. Est allé aux États-Unis deux fois, ainsi qu'à Hong Kong et Macao, et dans la moitié de la Chine. A suivi des cours d'anglais en ligne avec 60 professeurs d'anglais philippins, et certains professeurs africains ou européens aussi.
...
- A géré le cycle de développement complet, du développement local aux tests UAT et aux mises en production. Copilot a été largement utilisé pour des tâches étendues comme l'analyse des causes racines, la génération de scripts Python, et la documentation d'environ 50 guides techniques; certains de ces guides sont devenus des références clés pour les coéquipiers faisant face à des défis similaires.
...
- Avec Fun Live, les utilisateurs pouvaient participer à diverses conférences de connaissances telles que la programmation ou le design. Les utilisateurs pouvaient payer des frais pour assister aux sessions en direct ou récompenser les conférenciers. Le conférencier utilisait l'outil OBS pour pousser les flux en direct vers le serveur. Les utilisateurs pouvaient participer à la conférence en temps réel ou voir la rediffusion plus tard. La plateforme s'intégrait parfaitement avec WeChat pour les notifications. A accueilli environ 80 conférences, gagné 30 000 utilisateurs et des millions de vues de pages.
...
- Se prépare actuellement pour 7 cours tels que Réseaux Informatique, Technologie Électronique de Base (III), Micro-ordinateurs et Technologie d'Interface, Pensée de Mao Zedong et Théorie du Socialisme aux Caractéristiques Chinoises, Éducation Idéologique et Morale et État de Droit, Chinois Universitaire et Algèbre Linéaire.
...
- Classé dans le top 1 dans la compétition mensuelle d'entraînement ACM/ICPC de mon école parmi environ 100 étudiants de haut niveau de l'université, y compris la classe supérieure.
...
- Connaissance de l'industrie: Banque et Paiements, Plateformes d'Éducation et d'E-Learning, Réseaux Sociaux et Plateformes de Contenu, Gestion des Utilisateurs et des Comptes, Systèmes de Notification, Données et Analyse, Applications Mobiles, Systèmes de Paiement, Gestion des Transactions, Intégration des Réseaux Sociaux, Gestion de Vidéo, Systèmes de Récompense, Suivi en Direct, Gestion d'Applications, Fonds Communs de Placement et Trading d'Actions, Environnements de Programmation Basés sur le Navigateur.
...
- A postulé deux fois à Y Combinator. Une fois, a atteint le deuxième tour avec un taux d'acceptation d'environ 3%, bien que n'ayant pas été retenu dans la promotion.
...
- En tant qu'utilisateur précoce de Blue Sky, j'ai commenté le premier post de Jeff Dean ici et ai reçu un like de sa part; il est le Chief Scientist de Google.
...
- Certificat d'achèvement du cours de spécialisation Machine Learning, fourni par DeepLearning.AI et Standford University
- Certificat d'achèvement du cours de spécialisation Deep Learning, fourni par DeepLearning.AI
