...
- A analysé et réimplémenté certaines parties centrales d'environ 30 projets d'exemples sur le machine learning, issus de tutoriels PyTorch, TensorFlow, cours Coursera ou autres projets open-source. A obtenu deux certificats de cours complétés sur Coursera sur la spécialisation Machine Learning et Deep Learning Specialization.
...
- A maintenu un blog technique avec 431 articles de blog originaux. A utilisé des grands modèles de langage pour traduire le contenu dans 9 langues, fournir des audios de synthèse vocale, supporter les formats PDF et EPUB, intégrer les workflows GitHub, et utiliser LaTeX pour rédiger des articles ou créer un CV. D'autres technologies employées incluent Python, Jekyll, Deepseek, et Mistral. Le site web est https://lzwjava.github.io.
...
- Classé dans le top 1 de la compétition mensuelle d'entraînement ACM/ICPC de mon école parmi environ 100 étudiants de haut niveau de l'université, y compris les étudiants de niveau supérieur.
...
- Rapport officiel de l'enseignement supérieur chinois (Éducation de niveau licence, Statut d'abandon)
- IELTS Academics, Score 6
- Certificat de complétion du cours de spécialisation Machine Learning, fourni par DeepLearning.AI et Standford University
- Certificat de complétion du cours de spécialisation Deep Learning, fourni par DeepLearning.AI
