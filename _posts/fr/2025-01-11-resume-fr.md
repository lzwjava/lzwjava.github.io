...
- Ingénieur avec un esprit entrepreneurial et une mentalité produit, utilisant 3 téléphones mobiles et mille applications et jeux à essayer. Travaille comme un agent IA autonome, compétent avec de nombreux outils IA, et s'améliore avec un logging et des tests complets.
...
- A analysé et réimplémenté certaines parties centrales autour de 30 projets d'exemple sur le machine learning, issus de tutoriels PyTorch, TensorFlow, cours Coursera ou autres projets open-source. A obtenu deux certificats de complétion de cours sur Coursera pour la spécialisation Machine Learning et la spécialisation Deep Learning.
...
- A maintenu un blog technique avec 431 publications originales. A utilisé de grands modèles de langage pour traduire le contenu en 9 langues, fournir des audios texte-à-parole, supporter les formats PDF et EPUB, intégrer les workflows GitHub, et utiliser LaTeX pour écrire des articles ou créer un CV. D'autres technologies employées incluent Python, Jekyll, Deepseek et Mistral. Le site web est https://lzwjava.github.io.
...
- A remporté le troisième prix au concours de créativité des œuvres numériques "Jeunesse, Santé, Nouveaux Médias" organisé par l'UNESCO et l'Université de Communication de Chine pour l'œuvre numérique "Mom Shy To Say".
...
- Programme WeChat Mini Program de la Super Brain TV (2018.2 - 2018.3) Responsable du développement backend et frontend. Utilisation de stacks technologiques comme Java, Spring, JavaScript, HTML et AliCloud.
...
Ci-dessous sont des outils détaillés qui m'aident à accumuler les compétences ci-dessus, plus d'autres outils intéressants. J'utilise encore certains d'entre eux et je peux apprendre pendant quelques jours pour utiliser le reste.
...
- A postulé à Y Combinator deux fois. Une fois, est entré dans le deuxième tour avec un taux d'acceptation d'environ 3%, bien qu'il n'ait pas été accepté dans la promotion.
...
- En tant qu'investisseur en crypto et en actions américaines depuis 2018, j'ai pris une pause en raison de certaines pertes mais j'ai repris l'investissement en 2024, en utilisant des pratiques d'investissement à long terme et régulières. Malgré le montant modeste, je suis satisfait d'avoir obtenu un bénéfice de 25% de NVIDIA après un an d'investissement régulier en juillet 2025, ainsi qu'un bénéfice de 30% de certaines de mes investissements en Bitcoin.
