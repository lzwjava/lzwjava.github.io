...
- A analysé et réimplémenté certaines parties centrales autour de 30 projets d'exemple sur le machine learning, provenant de tutoriels PyTorch, TensorFlow, cours en ligne Coursera ou autres projets open-source. A obtenu deux certificats de réussite de cours sur Coursera concernant la spécialisation en Machine Learning et la spécialisation en Deep Learning.
...
- A maintenu un blog technique avec 431 publications originales. A utilisé des grands modèles de langage pour traduire le contenu en 9 langues, fournir des audios de synthèse vocale, supporter les formats PDF et EPUB, intégrer les workflows GitHub, et utiliser LaTeX pour rédiger des articles ou créer un CV. D'autres technologies employées incluent Python, Jekyll, Deepseek et Mistral. Le site web est https://lzwjava.github.io.
...
- Du point de vue de l'ingénierie, j'ai effectué la plupart du développement logiciel, résultant en environ 2 000 commits de code à travers 3 applications client web et 1 serveur. Ils ont été open-sourcés sur GitHub@lzwjava quelques années plus tard. Le projet a utilisé PHP, Vue, HTML, CodeIgniter, MySQL, Redis, LeanCloud, Alibaba Cloud, WeChat SDK, SRS (Simple Realtime Server), WeChat MiniProgram, Fabric, Linux et Nginx. J'ai également fait un peu de design dans Sketch.
- Pendant la période de conseil logiciel, j'ai complété 50 petits projets logiciels pour les clients, incluant des sites web, des jeux et des applications. Le revenu était d'environ 3 millions de RMB et le profit d'environ 700 000 RMB. Responsable de la négociation de projets, de la gestion d'équipe et de certains développements logiciels. Des projets notables sont présentés ci-dessous.
...
- Classé dans le top 1 de la compétition de formation mensuelle ACM/ICPC de mon école parmi environ 100 étudiants de haut niveau de l'université, y compris une année supérieure.
...
- A fondé deux startups: une avec des cofondateurs, et une créée par moi-même. La dernière a gagné 30k utilisateurs et a une fois atteint un revenu de 3 millions de CNY par an.
...
- A lu environ 100 livres sur les affaires, la gestion et les produits. A quelques connexions avec des personnes qui sont des experts dans ces domaines.
