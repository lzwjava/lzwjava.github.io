...
- Accumulé 11 ans d'expérience professionnelle, incluant 8 ans en postes d'entreprise et 3 ans en tant que freelance. Spécialisé en 2 ans d'ingénierie mobile (Android, iOS), 8 ans d'ingénierie full-stack (7 ans backend, 1 an frontend), et 1 an en machine learning/big data.
...
- Ingénieur avec un esprit entrepreneurial et un état d'esprit produit, utilisant 3 téléphones mobiles et mille applications et jeux pour s'amuser. Travaille comme un agent IA autonome, compétent avec de nombreux outils IA, et devient meilleur avec un logging et des tests complets.
...
- A complété divers projets logiciels en tant que freelance, développement de site web pour enseignes LED, intégration WeChat d'entreprise pour ShowMeBug, scraper web pour la collecte de données commerciales, outil eBook mathjax2mobi.
...
- Intégration WeChat d'entreprise pour ShowMeBug: A contribué à l'intégration de ShowMeBug avec WeChat d'entreprise, permettant un accès fluide aux outils d'entretien technique au sein de l'écosystème WeChat d'entreprise. A utilisé des technologies comme Ruby, Ruby On Rails, PostgreSQL et le SDK WeChat pour créer une expérience utilisateur fluide pour les interviewers et les candidats.
...
- Chongding Conference (2017.9 - 2018.1) Responsable d'une partie du développement backend et du développement frontend du panneau d'administration pour une application de quiz en direct. Utilisation de stacks technologiques comme Java, Spring, WebSocket, et Netty.
...
- Certificat d'achèvement du cours de spécialisation en Machine Learning, fourni par DeepLearning.AI et Stanford University
