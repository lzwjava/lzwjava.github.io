...
- A étudié pendant un an à l'Université forestière de Pékin avant d'abandonner. Poursuit un diplôme d'associé par l'autoformation, avec neuf cours complétés.
...
- Accumule 11 ans d'expérience professionnelle, dont 8 ans en poste et 3 ans en freelance.
...
- Familier avec les modules de logging, bases de données, et microservices sur Alibaba Cloud, AWS, et Azure.
...
- A maintenu des fonctionnalités pour le traitement des données financières incluant l'import, la validation, et l'export, tout en améliorant les workflows de soumission et d'approbation pour les nouveaux en-têtes financiers. A exploité son expertise en comptabilité, grands livres, et systèmes bancaires.
...
- A développé des solutions bancaires innovantes en exploitant des outils d'IA comme Copilot, le profilage de performance avec YourKit, et des tests systématiques tout en fonctionnant comme un agent IA autonome qui analysait l'architecture du projet, collaborait avec les équipes, et s'améliorait continuellement grâce à une journalisation et une documentation complètes.
...
- A analysé et réimplémenté certaines parties centrales d'environ 30 projets d'exemple sur le machine learning, issus de tutoriels PyTorch, TensorFlow, cours Coursera ou autres projets open-source. A obtenu deux certificats de cours complétés sur Coursera pour la spécialisation Machine Learning et Deep Learning Specialization.
- S'est préparé pour des examens liés à l'obtention d'un diplôme d'associé, avec un focus sur des sujets comme les mathématiques avancées, l'organisation des ordinateurs, l'algèbre linéaire, etc. A écouté beaucoup de chansons japonaises et regardé beaucoup de vidéos TikTok japonaises pour apprendre la langue.
...
- A maintenu un blog technique avec 431 articles originaux. A utilisé des grands modèles de langage pour traduire le contenu en 9 langues, fournir des audios texte-à-parole, supporter les formats PDF et EPUB, intégrer les workflows GitHub, et utiliser LaTeX pour rédiger des articles ou créer un CV. D'autres technologies employées incluent Python, Jekyll, Deepseek, et Mistral. Le site web est https://lzwjava.github.io.
- A mené des expériences avec llama.cpp, embeddings, rerankers, Retrieval-Augmented Generation, et le benchmark MMLU. A exploré des intégrations de fournisseurs de moteurs de recherche comme Jina AI, Tavily AI Search API, et ElevenLabs API.
...
- Pendant la période de conseil logiciel, j'ai complété 50 petits projets logiciels pour des clients, incluant des sites web, des jeux, et des applications. Le revenu était d'environ 3 millions RMB et le profit d'environ 700 000 RMB. Responsable de la négociation de projets, de la gestion d'équipe, et de certains développements logiciels. Des projets notables sont présentés ci-dessous.
- MianbaoLive: A dirigé un effort complet de refactorisation backend pour MianbaoLive, une plateforme de monétisation de contenu et d'économie sociale tout-en-un. A optimisé la performance, la stabilité, et l'expérience utilisateur de l'ensemble de la stack technologique. Auparavant utilisé ThinkPHP, Node.js, et Go, et tout réécrit en Laravel pour le développement côté serveur. La plateforme incluait des modules pour les cours, les utilisateurs, le contenu, la présence des utilisateurs, les paiements, et les ventes de distribution. A collaboré avec Himalaya, une plateforme audio de premier plan en Chine, et synchronisé le contenu entre les plateformes.
...
- A employé une stack technologique robuste, exploitant des outils modernes tels que le SDK iOS, le SDK Android, Cocoapods, Xcode, Android Studio, et le framework Angular.
...
- Classé dans le top 1 des compétitions mensuelles d'entraînement ACM/ICPC de mon école parmi environ 100 étudiants de haut niveau de l'université, y compris les étudiants de niveau supérieur.
- A remporté le troisième prix du concours de créativité des œuvres numériques "Jeunesse, Santé, Nouveaux Médias" organisé par l'UNESCO et l'Université des Communications de Chine pour l'œuvre numérique "Maman Timide de Dire".
...
- Li, Zhiwei. (Nov 2024). *Restauration de la Vision Naturelle: Le Principe du 'Juste Assez Clair'.* Blog de Zhiwei. https://lzwjava.github.io/barely-clear-en.
