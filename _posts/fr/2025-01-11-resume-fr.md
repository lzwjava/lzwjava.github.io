...
- Chercheur autodidacte avec trois articles de style académique sur l'inversion de la myopie et la restauration de la vision naturelle, inspiré des travaux de Yin Wang et Todd Becker, soutenus par trois ans d'expérimentation.
...
- Hacker de vie dans tous les aspects de la vie, avec mille pratiques innovantes—de l'apporter un deuxième appareil mobile pour aider sa fille à apprendre l'anglais en Chine, à utiliser une ventilation de voiture pour sécher les cheveux; amateur de friteuse à air; possède des centaines de petits outils et gadgets comme un compteur de champs électriques/magnétiques, etc.
...
- A analysé et réimplémenté certaines parties centrales autour de 30 projets d'exemple sur le machine learning, provenant de PyTorch, TensorFlow, cours en ligne Coursera ou autres projets open-source. A obtenu deux certificats de fin de cours Coursera sur la spécialisation Machine Learning et la spécialisation Deep Learning.
...
- Web scraper pour la collecte de données commerciales: A développé un web scraper utilisant Python et Selenium pour collecter des données commerciales pour une entreprise de tissu non tissé. A automatisé l'extraction et la navigation des données, traité et stocké les données dans une base de données SQLite, et généré des rapports pour l'analyse commerciale.
...
- A réussi 13 cours, comme Introduction à l'Informatique, Fondements de la Programmation, Laboratoire de Fondements de la Programmation, Anglais Universitaire, Mathématiques Avancées, Principes et Techniques d'Imagerie Numérique, Technologie de Graphisme en Deux Dimensions.
...
- A reçu le troisième prix au concours de créativité de travaux numériques "Jeunesse, Santé, Nouveaux Médias" organisé par l'UNESCO et l'Université de Communication de Chine pour le travail numérique "Maman Timide de Dire".
...
- SDK LeanCloud et LeanChat (2014.07 - 2015.10) Responsable de certains développements SDK Objective-C et Java, et de tout le développement de leur application démonstration LeanChat.
...
Ci-dessous sont des outils détaillés qui m'aident à accumuler les compétences ci-dessus, plus d'autres outils intéressants. J'utilise encore certains d'entre eux et peux apprendre pendant quelques jours pour utiliser le reste d'entre eux à nouveau.
...
- Connaissance de l'industrie: Banque et Paiements, Plateformes d'Éducation et d'E-learning, Plateformes de Réseaux Sociaux et de Contenu, Gestion des Utilisateurs et des Comptes, Systèmes de Notification, Données et Analyse, Applications Mobiles, Systèmes de Paiement, Gestion des Transactions, Intégration des Réseaux Sociaux, Gestion de Vidéo, Systèmes de Récompense, Suivi en Temps Réel, Gestion d'Applications, Fonds Communs de Placement et Trading d'Actions, Environnements de Programmation Basés sur Navigateur.
...
Je suis un chercheur autodidacte avec trois articles de style académique sur l'inversion de la myopie et la restauration de la vision naturelle, inspiré des travaux de Yin Wang et Todd Becker, soutenus par trois ans d'expérimentation. En informatique, je m'efforce encore de faire des percées similaires.
...
- A fondé deux startups: une avec des cofondateurs, et une créée par moi-même. La dernière a gagné 30k utilisateurs et a atteint un chiffre d'affaires de 3 millions de CNY par an.
...
- A postulé deux fois à Y Combinator. Une fois, a atteint le deuxième tour avec un taux d'acceptation d'environ 3%, bien que n'ayant pas été accepté dans la promotion.
...
- En tant qu'utilisateur précoce de Blue Sky, j'ai commenté le premier post de Jeff Dean ici et j'ai reçu un like de lui; il est le Chief Scientist de Google.
...
- Certificat de Fin de Cours de Spécialisation en Machine Learning, fourni par DeepLearning.AI et Standford University
