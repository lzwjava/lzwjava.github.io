...
- Natif en chinois, anglais courant (IELTS 6). A lu plus de 320 livres couvrant les manuels, le développement personnel, les affaires, la technologie et l'histoire. A lu environ 2000 réponses complètes et longues d'IA au cours de l'année passée.
...
- Farben est un fournisseur leader de services technologiques logiciels en Chine. HSBC Bank est l'une des plus grandes institutions de services bancaires et financiers au monde. PayMe est un service de paiement mobile HSBC destiné aux résidents de Hong Kong.
...
- A complété divers projets logiciels en tant que freelance, développement de site web pour enseignes LED, intégration de WeChat Entreprise pour ShowMeBug, scraper web pour la collecte de données commerciales, outil eBook mathjax2mobi.
...
- Intégration de WeChat Entreprise pour ShowMeBug: A contribué à l'intégration de ShowMeBug avec WeChat Entreprise, permettant un accès fluide aux outils d'entretien technique dans l'écosystème WeChat Entreprise. A utilisé des technologies comme Ruby, Ruby On Rails, PostgreSQL et le SDK WeChat pour créer une expérience utilisateur fluide pour les interviewers et les candidats.
...
- MianbaoLive: A dirigé un effort de refactorisation complet du backend de MianbaoLive, une plateforme de monétisation de contenu et d'économie sociale tout-en-un. A optimisé les performances, la stabilité et l'expérience utilisateur de l'ensemble de la stack technologique. A précédemment utilisé ThinkPHP, Node.js et Go, et a réécrit tout en Laravel pour le développement côté serveur. La plateforme incluait des modules pour les cours, les utilisateurs, le contenu, la présence des utilisateurs, les paiements et les ventes de distribution. A collaboré avec Himalaya, l'une des principales plateformes audio en Chine, et synchronisé le contenu entre les plateformes.
...
- Ma première tentative entrepreneuriale était avec 5 cofondateurs, qui m'ont beaucoup aidé avec mon propre démarrage et m'ont inspiré à devenir meilleur. Nous venions de grandes entreprises ou de startups de pointe à Pékin. Ce n'est que plus tard dans la vie que j'ai pu apprécier l'esprit entrepreneurial à Pékin et la plus grande chance de rencontrer des personnes qui rêvent grand et poursuivent l'excellence plutôt que de faire des emplois médiocres. L'atmosphère à Pékin à cette époque était assez unique et excitante.
...
Ci-dessous sont des outils détaillés qui m'aident à accumuler les compétences ci-dessus, plus d'autres outils intéressants. J'utilise encore certains d'entre eux et peux apprendre pendant quelques jours pour utiliser le reste.
...
J'ai lu plus de 320 livres couvrant les manuels, le développement personnel, les affaires, la technologie et l'histoire. Ci-dessous sont des livres et ressources clés qui ont façonné ma pensée.
