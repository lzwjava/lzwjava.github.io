...
- Accumule 11 ans d'expérience professionnelle, dont 8 ans en poste et 3 ans en freelance. Spécialisé en 2 ans d'ingénierie mobile (Android, iOS), 8 ans d'ingénierie full-stack (7 ans backend, 1 an frontend), et 1 an en machine learning/big data.
...
- Natif en chinois, anglais courant (IELTS 6). A lu plus de 320 livres couvrant des manuels, développement personnel, affaires, technologie et histoire. A lu environ 2000 réponses longues et complètes d'IA au cours de l'année passée.
...
- Ingénieur avec un esprit entrepreneurial et une mentalité produit, utilisant 3 téléphones mobiles et mille applications et jeux à expérimenter. Travaille comme un agent IA autonome, compétent avec de nombreux outils IA, et s'améliore avec un logging et des tests complets.
- Hacker de vie dans tous les aspects de la vie, avec mille pratiques innovantes—de l'apport d'un deuxième appareil mobile pour aider sa fille à apprendre l'anglais en Chine, à l'utilisation d'une aération de voiture pour sécher les cheveux; amoureux de l'air fryer; possède des centaines de petits outils et gadgets comme un compteur de champs électriques/magnétiques, etc.
- Amoureux des voyages et maître des road trips. A visité les États-Unis deux fois, ainsi que Hong Kong et Macao, et la moitié de la Chine. A suivi des cours d'anglais en ligne avec 60 professeurs d'anglais philippins, et quelques professeurs africains ou européens également.

## Expérience professionnelle

### Meitai Technology Service (Shanghai) Co., Ltd. Guangzhou Branch, Ingénieur Backend, 2025.02 - Présent

- Ingénieur Backend externalisé pour HSBC Bank sous TEKsystems, développant et optimisant les systèmes backend pour la plateforme de transformation financière du département Technologie d'entreprise de HSBC.
...
- A analysé et réimplémenté certaines parties centrales autour de 30 projets d'exemple sur le machine learning, provenant de tutoriels PyTorch, TensorFlow, cours Coursera ou autres projets open-source. A obtenu deux certificats de fin de cours Coursera sur la spécialisation Machine Learning et la spécialisation Deep Learning.
...
- A maintenu un blog technique avec 431 publications originales. A utilisé des grands modèles de langage pour traduire le contenu en 9 langues, fournir des audios texte-à-parole, supporter les formats PDF et EPUB, s'intégrer avec les workflows GitHub, et utiliser LaTeX pour écrire des articles ou créer un CV. D'autres technologies employées incluent Python, Jekyll, Deepseek, et Mistral. Le site web est https://lzwjava.github.io.
...
- Beyondsoft Consulting est une entreprise leader en conseil et IT d'entreprise. DBS Bank est la plus grande banque d'Asie du Sud-Est en termes d'actifs et parmi les plus grandes banques d'Asie. En contrat avec Beyondsoft, assigné pour travailler pour DBS Bank et a contribué aux projets DBS Client Connect et DBS DigiBank CN.
...
- A complété divers projets logiciels en tant que freelance, développement de site web pour enseignes LED, intégration WeChat Entreprise pour ShowMeBug, scraper web pour la collecte de données commerciales, outil eBook mathjax2mobi.
...
- Intégration WeChat Entreprise pour ShowMeBug: A contribué à l'intégration de ShowMeBug avec WeChat Entreprise, permettant un accès fluide aux outils d'entretien technique dans l'écosystème WeChat Entreprise. A utilisé des technologies comme Ruby, Ruby On Rails, PostgreSQL et le SDK WeChat pour créer une expérience utilisateur fluide pour les interviewers et les candidats.
...
- Du point de vue de l'ingénierie, j'ai effectué la majeure partie du développement logiciel, aboutissant à environ 2 000 commits de code à travers 3 applications client web et 1 serveur. Ils ont été open-sourcés sur GitHub@lzwjava quelques années plus tard. Le projet a utilisé PHP, Vue, HTML, CodeIgniter, MySQL, Redis, LeanCloud, Alibaba Cloud, WeChat SDK, SRS (Simple Realtime Server), WeChat MiniProgram, Fabric, Linux, et Nginx. J'ai également fait un peu de design dans Sketch.
- Pendant la période de conseil logiciel, j'ai complété 50 petits projets logiciels pour des clients, incluant des sites web, des jeux et des applications. Le chiffre d'affaires était d'environ 3 millions de RMB et le profit d'environ 700 000 RMB. Responsable de la négociation de projets, de la gestion d'équipe, et d'une partie du développement logiciel. Des projets notables sont présentés ci-dessous.
- MianbaoLive: A dirigé un effort de refactorisation complète du backend pour MianbaoLive, une plateforme de monétisation de contenu et d'économie sociale tout-en-un. A optimisé les performances, la stabilité et l'expérience utilisateur de l'ensemble de la stack technologique. A précédemment utilisé ThinkPHP, Node.js, et Go, et a tout réécrit en Laravel pour le développement côté serveur. La plateforme incluait des modules pour les cours, les utilisateurs, le contenu, la présence des utilisateurs, les paiements, et les ventes de distribution. A collaboré avec Himalaya, l'une des principales plateformes audio en Chine, et synchronisé le contenu entre les plateformes.
...
- A participé au développement du SDK Objective-C et Java de LeanCloud. Responsable du développement du client iOS et Android de LeanChat, une application de chat conçue pour démontrer le SDK de messagerie instantanée. A également travaillé sur divers projets frontend. A employé une stack technologique robuste, en utilisant des outils modernes tels que le SDK iOS, le SDK Android, Cocoapods, Xcode, Android Studio, et le framework Angular.
...
- PayMe de HSBC (2022.11 - 2023.07) Participation au développement backend de la fonction de recharge automatique et à la migration cloud. Utilisation de stacks technologiques comme Java, Spring Cloud, Azure, et AWS.
...
- ShowMeBug (2021.7 - 2021.9) Responsable de l'intégration entre la plateforme et WeChat Entreprise, incluant la connexion et l'entrée facile pour les entretiens. Utilisation de stacks technologiques comme Ruby on Rails, PostgreSQL, et WeChat SDK.
...
- Fun Live (2016.6 - 2017.9) Responsable de la majeure partie du développement du code d'une plateforme de diffusion en direct de connaissances. Utilisation de stacks technologiques comme PHP, JavaScript, HTML, AliCloud, et streaming RTMP.
...
- A acquis beaucoup de pratique d'influence sur les réseaux sociaux, incluant le blogging, le canal d'abonnement WeChat, TikTok, WeChat Videos, Weibo et LinkedIn. A acquis des milliers d'abonnés dans plusieurs comptes ou 60k vues de pages par an.
