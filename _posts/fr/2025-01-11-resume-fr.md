...
* A étudié pendant un an à l'Université forestière de Pékin avant d'abandonner. Poursuit un diplôme d'associé par l'auto-formation, avec neuf cours terminés.
...
- A géré l'ensemble du cycle de développement, de la développement local aux tests UAT et aux mises en production. J'ai également résolu des problèmes tels que les deadlocks et les procédures IBM Db2. Copilot a été largement utilisé pour des tâches étendues telles que l'analyse des causes racines, la génération de scripts Python et la documentation de guides techniques ; certains de ces guides sont devenus des références clés pour les coéquipiers confrontés à des défis similaires.
...
* A maintenu un blog technique avec 431 articles de blog originaux. A utilisé des grands modèles de langage pour traduire le contenu en 9 langues, fournir des audios de synthèse vocale, supporter les formats PDF et EPUB, s'intégrer avec les workflows GitHub, et utiliser LaTeX pour rédiger des articles ou créer un CV. D'autres technologies employées incluent Python, Jekyll, Deepseek et Mistral. Le site web est https://lzwjava.github.io.
...
* A remporté le troisième prix du concours de créativité des œuvres numériques "Jeunesse, Santé, Nouveaux Médias" organisé par l'UNESCO et l'Université de la Communication de Chine pour l'œuvre numérique "Maman Timide de Dire".
...
* PayMe de HSBC (2022.11 - 2023.07) Participation au développement backend de la fonctionnalité Auto Top Up et migration vers le cloud. Utilisation de stacks technologiques comme Java, Spring Cloud, Azure et AWS.
...
* Connaissance de l'industrie : Banque et Paiements, Plateformes d'Éducation et d'E-learning, Réseaux Sociaux et Plateformes de Contenu, Gestion des Utilisateurs et des Comptes, Systèmes de Notification, Données et Analyse, Applications Mobiles, Systèmes de Paiement, Gestion des Transactions, Intégration des Réseaux Sociaux, Gestion Vidéo, Systèmes de Récompense, Suivi des Vues en Direct, Gestion d'Applications, Fonds Communs de Placement et Trading d'Actions, Environnements de Programmation Basés sur Navigateur.
