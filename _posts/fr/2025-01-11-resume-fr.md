...
- Amoureux des voyages et maître des road trips. A visité les États-Unis deux fois vers l'âge de 21 ans, ainsi qu'Hong Kong et Macao, et la moitié de la Chine. A suivi des cours d'anglais en ligne avec 60 professeurs d'anglais philippins, et certains professeurs africains ou européens aussi.
...
- A géré le cycle de développement complet, du développement local aux tests UAT et aux mises en production. Copilot a été largement utilisé pour des tâches étendues comme l'analyse des causes profondes, la génération de scripts Python, et la documentation d'environ 50 guides techniques; certains de ces guides sont devenus des références clés pour les coéquipiers confrontés à des défis similaires.
...
- Beyondsoft Consulting est une entreprise leader en IT et conseil d'entreprise. DBS Bank est la plus grande banque d'Asie du Sud-Est en termes d'actifs et parmi les plus grandes banques d'Asie. En contrat avec Beyondsoft, affecté pour travailler pour DBS Bank et a contribué aux projets DBS Client Connect et DBS DigiBank CN.
...
- Avec Fun Live, les utilisateurs pouvaient participer à diverses conférences de connaissances comme la programmation ou le design. Les utilisateurs pouvaient payer des frais pour assister aux sessions en direct ou récompenser les conférenciers. Le conférencier utilisait l'outil OBS pour pousser les flux en direct vers le serveur. Les utilisateurs pouvaient participer à la conférence en temps réel ou voir la rediffusion plus tard. La plateforme s'intégrait parfaitement avec WeChat pour les notifications. A hébergé environ 80 conférences, gagné 30 000 utilisateurs et des millions de vues de pages.
...
- Du point de vue de l'ingénierie, j'ai effectué la plupart du développement logiciel, résultant en environ 2 000 commits de code à travers 3 applications client web et 1 serveur. Ils ont été open source sur GitHub@lzwjava quelques années plus tard. Le projet a exploité PHP, Vue, HTML, CodeIgniter, MySQL, Redis, LeanCloud, Alibaba Cloud, le SDK WeChat, SRS (Simple Realtime Server), WeChat MiniProgram, Fabric, Linux, et Nginx. J'ai également fait un peu de design dans Sketch.
...
- Projets de Square Root Inc (2018.1 - 2019.12) Participation à 50 projets variés incluant des sites web, des jeux, des applications, et des mini-programmes WeChat. Responsable de la gestion d'équipe, de la négociation de contrats, de la gestion de projets, des communications clients, et de certains développements logiciels.
...
- Transformer les Conférences de Feynman sur les Pages Web de Physique en un eBook
