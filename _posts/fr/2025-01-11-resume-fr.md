...
- Chinois natif, anglais courant (IELTS 6). A lu plus de 320 livres couvrant les manuels, le développement personnel, les affaires, la technologie et l'histoire. A lu environ 2000 réponses complètes et longues d'IA au cours de l'année passée.
...
- Ingénieur avec un esprit entrepreneurial et un état d'esprit produit, utilisant 3 téléphones mobiles et mille applications et jeux à essayer. A travaillé comme agent IA autonome, compétent avec de nombreux outils IA, et devenant meilleur avec une journalisation et des tests complets.
...
- Amateur de voyages et maître des road trips. A visité les États-Unis deux fois vers l'âge de 21 ans, ainsi que Hong Kong et Macao, et la moitié de la Chine. A suivi des cours d'anglais en ligne avec 60 professeurs d'anglais philippins, et certains professeurs africains ou européens également.
...
- A maintenu un blog technique avec 431 publications de blog originales. A utilisé des grands modèles de langage pour traduire le contenu dans 9 langues, fournir des audios texte-parole, prendre en charge les formats PDF et EPUB, intégrer les workflows GitHub, et utiliser LaTeX pour rédiger des articles ou créer un CV. D'autres technologies employées incluent Python, Jekyll, Deepseek et Mistral. Le site web est https://lzwjava.github.io.
...
- Beyondsoft Consulting est une entreprise leader en informatique et conseil d'entreprise. DBS Bank est la plus grande banque d'Asie du Sud-Est en termes d'actifs et parmi les plus grandes banques d'Asie. En contrat avec Beyondsoft, assigné à travailler pour DBS Bank et a contribué aux projets DBS Client Connect et DBS DigiBank CN.
...
- ShowMeBug (2021.7 - 2021.9) Responsable de l'intégration entre la plateforme et Enterprise WeChat, incluant la connexion et l'entrée facile à l'entretien. Utilisation de stacks technologiques comme Ruby on Rails, PostgreSQL et WeChat SDK.
...
Ci-dessous sont les outils détaillés qui m'aident à accumuler les compétences ci-dessus, plus d'autres outils intéressants. J'utilise encore certains d'entre eux et je peux apprendre pendant quelques jours pour utiliser les autres à nouveau.
...
- A obtenu un investissement d'environ 500 000 CNY dans sa startup à l'âge de 22 ans, et l'a rendu à l'investisseur lors de la fermeture.
- A postulé deux fois à Y Combinator. Une fois, est entré dans le deuxième tour avec un taux d'acceptation d'environ 3%, bien qu'il n'ait pas été accepté dans le lot.
...
- A acquis beaucoup de pratique d'influence sur les réseaux sociaux, incluant le blogging, le canal d'abonnement WeChat, TikTok, les vidéos WeChat, Weibo et LinkedIn. A acquis des milliers d'abonnés ou 60k vues de pages par an.
- Utilise 3 téléphones mobiles et des milliers d'applications et jeux pour expérimenter, incluant différents types d'applications de dizaines de pays.
