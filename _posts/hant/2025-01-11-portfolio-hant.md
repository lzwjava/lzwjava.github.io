...
這些軟體代表了我多年來有幸與各大知名公司和合作夥伴共同參與的多元化專案。
...
我解決的演算法問題涵蓋了各個領域，包括數據結構、圖形、數學、字符串處理、幾何以及其他高級或專業主題。

## 花卉辨識，Android，2014.4 - 2014.8

開發了一個花卉辨識的Android應用程序，旨在幫助用戶通過拍攝照片和繪製圓圈來辨識花卉。
...
[在GitHub上開源](https://github.com/lzwjava/flower-recognition)，33次提交。

## iword，Android，2014.3

一個通過觀看電影片段幫助用戶學習英語的Android應用程序。

**使用技術：** Android SDK, Java

**職責：**
- 開發了電影片段播放和學習界面。
- 實現了通過互動內容提高詞彙量和理解力的功能。

**成就：** 在2014年AVOS雲端黑客馬拉松中獲得第三名。

[SegmentFault：2014年AVOS雲端黑客馬拉松成就回顧](https://segmentfault.com/a/1190000000427302)

## 北京林業大學助手，Android，2014.1 - 2014.6

一個整合了查詢成績和參與校友論壇等功能的校園助手Android應用程序。
...
LeanChat是一個聊天應用程序，包含了好友管理、群組管理、基於位置的消息、附近的人、個人資料和登錄/註冊等功能，完全利用了LeanCloud的存儲和通信能力。
...
[在GitHub上開源](https://github.com/lzwjava/leanchat-android)，412次提交。
...
開發了LeanChat的iOS版本，一個利用LeanCloud後端服務進行消息傳遞和存儲的聊天應用程序。
...
[在GitHub上開源](https://github.com/lzwjava/leanchat-ios)，446次提交。
...
參與了LeanCloud的Java SDK和Objective-C SDK的開發，為開發者提供了工具，使其能夠輕鬆地將LeanCloud服務整合到他們的應用程序中。

**使用技術：** Java, Objective-C, LeanCloud

**職責：**
- 貢獻於LeanCloud的Java SDK和Objective-C SDK的開發。
- 確保LeanCloud服務如物件存儲、文件存儲和消息傳遞的無縫整合。
...
在[GitHub](https://github.com/lzwjava/TabsKiller)上開源，19次提交。
...
創建了一個Xcode插件，旨在實現當前存儲庫中關鍵GitHub功能的無縫導航。該插件允許用戶快速訪問GitHub歷史記錄、責備、拉取請求、問題和通知。

**使用技術：** Objective-C, Xcode插件API

在[GitHub](https://github.com/lzwjava/Reveal-In-GitHub)上開源，57次提交。
...
開發了江蘇衛視超級大腦節目的微信小程序，為用戶提供了互動的謎題。主持人通過口播廣播引導用戶，呈現特定的技術挑戰。
...
Chongding是一個類似HQ Trivia的手機問答應用程序，允許用戶參加有獎金的直播問答遊戲。
...
## 陸晨標誌，前端，2020.4 - 2020.5

陸晨標誌專注於為各種企業和活動生產廣告標誌。以質量和創意為重，致力於提供提升品牌形象和吸引觀眾的視覺解決方案。

開發了陸晨標誌的前端，一個專注於生產廣告標誌的網站。

**使用技術：** HTML, JavaScript, CSS, Bootstrap

**職責：**
- 設計並實現網站的前端。
- 創建了一個直觀且用戶友好的界面來展示產品。

在[GitHub](https://github.com/lzwjava/lvchensign)上開源，40次提交。在線頁面於[lvchesign.com](http://lvchensign.com)。
...
**職責：**
- 開發股票交易的後端服務。創建了股票顯示、客戶顯示、預交易檢查和訂單下達的功能。
...
**職責：**
- 與後端工程師團隊合作開發自動補款功能，當用戶的餘額低於一定金額時，自動從用戶的信用卡或借記卡中補款。
- 協作監控來自Azure EventHub的支付後事件，確保無縫整合並檢查用戶設置自動補款配置時的補款。
- 使用面向對象編程原則優雅地處理各種情況，並使用面向切面編程審計自動補款表的變更日誌。
- 在AWS遷移過程中協助團隊，排除IAM和RDS配置問題，以確保順利過渡。
...
- 維護財務數據處理功能，包括導入、驗證和導出，並增強新財務標頭的提交和批准工作流程，利用會計、總帳和銀行系統的專業知識。
- 管理從本地開發到UAT測試和生產發布的整個開發生命週期，使用Copilot執行根本原因分析、生成Python腳本和記錄約50份技術指南，這些指南成為團隊成員的關鍵參考。
- 使用AI工具如Copilot、性能分析工具YourKit和系統測試開發創新的銀行技術解決方案，並作為自主AI代理，分析項目架構、與團隊協作並通過全面的日誌記錄和文檔改進。
