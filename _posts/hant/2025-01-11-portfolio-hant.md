...
Uva Online Judge 紀錄可於[此處](https://uhunt.onlinejudge.org/id/113519)查看。
...
**職責：**
- 開發電影片段播放和學習界面。
- 通過互動內容實現提高詞彙量和理解力的功能。

**成就：** 在2014年AVOS雲黑客馬拉松中獲得第三名。

[SegmentFault：2014年AVOS雲黑客馬拉松成就回顧](https://segmentfault.com/a/1190000000427302)
...
LeanChat是一個聊天應用程式，包含好友管理、群組管理、基於位置的消息、附近的人、個人資料和登錄/註冊功能，充分利用LeanCloud的存儲和通信能力。
...
參與開發LeanCloud的Java SDK和Objective-C SDK，為開發者提供工具，使其能輕鬆將LeanCloud服務整合到應用程式中。
...
創建了一個Xcode外掛程式，專為在當前存儲庫中無縫導航到關鍵GitHub功能而設計。該外掛程式允許用戶快速訪問GitHub歷史、責任歸屬、拉取請求、問題和通知。
...
Mianbao Live是一站式內容變現和社交經濟解決方案提供商。
...
- 開發後端服務和管理面板前端。
- 設計和實現即時問答遊戲功能。
- 貢獻技術解決方案，使用SEI（補充增強信息）同步直播與遊戲事件。
...
## Square Root Inc - 50個雜項專案，項目管理 & 部分軟體開發，2018.1 - 2019.12
...
將ShowMeBug整合到企業微信中，使其能夠在企業微信生態系統中無縫訪問技術面試工具。
...
陸晨簽專注於為各種企業和活動生產廣告標誌。以質量和創意為重點，致力於提供提升品牌形象和吸引觀眾的視覺解決方案。

開發了陸晨簽的前端，一個專注於生產廣告標誌的網站。
...
開源於[GitHub](https://github.com/lzwjava/lvchensign)，40次提交。在線頁面於[lvchensign.com](http://lvchensign.com)。
...
**職責：**
- 開發股票交易的後端服務。創建股票顯示、客戶顯示、交易前檢查和訂單放置功能。
...
DBS DigiBank CN重新思考並重新設計，讓您享受更快速、更方便的移動銀行體驗。
...
**職責：**
- 與後端工程師團隊合作開發自動補款功能，當用戶的餘額低於某個金額時，自動從用戶的信用卡或借記卡補款。
- 協作監控Azure EventHub的支付後事件，確保無縫整合並檢查用戶設置自動補款配置時的補款。
...
- 管理從本地開發到UAT測試和生產發布的整個開發生命週期，利用Copilot執行任務，如根本原因分析、生成Python腳本和記錄約50份技術指南，這些指南成為團隊成員的關鍵參考。
- 使用AI工具如Copilot開發創新的銀行技術解決方案，使用YourKit進行性能分析，系統測試，並作為自主AI代理，分析項目架構，與團隊合作並通過全面的日誌記錄和文檔改進。
