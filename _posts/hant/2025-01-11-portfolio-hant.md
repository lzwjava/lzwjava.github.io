...
這些軟體代表了我多年來有幸參與的各種項目，與多家知名公司和合作夥伴合作。
...
Uva Online Judge 的記錄可於[此處](https://uhunt.onlinejudge.org/id/113519)查看。

<div align="center"><img src="/assets/images/portfolio/uva.png"/><img /></div>

我解決的演算法問題涵蓋了各種領域，包括數據結構、圖形、數學、字符串處理、幾何以及其他多個高級或專業主題。
...
參與了LeanCloud的Java SDK和Objective-C SDK的開發，為開發者提供了工具，使他們能夠輕鬆地將LeanCloud服務整合到他們的應用程式中。

**使用技術：** Java, Objective-C, LeanCloud

**職責：**
- 貢獻於LeanCloud的Java SDK和Objective-C SDK的開發。
- 確保LeanCloud服務如物件存儲、文件存儲和消息的無縫整合。
...
Mianbao Live是一站式內容變現和社會經濟解決方案提供商。
...
開發了江蘇電視台超級大腦節目的微信小程序，為用戶提供互動謎題。主持人通過口播廣播引導用戶，提出特定技術挑戰。
...
- 開發後端服務和管理面板前端。
- 設計和實現即時問答遊戲功能。
- 貢獻了使用SEI（補充增強信息）同步直播流與遊戲事件的技術解決方案。
...
## Square Root Inc - 50個雜項項目，項目管理 & 部分軟體開發，2018.1 - 2019.12
...
將ShowMeBug整合到企業微信中，使技術面試工具能夠在企業微信生態系統中無縫訪問。
...
陸晨標誌專注於為各種企業和活動生產廣告標誌。以品質和創意為核心，致力於提供提升品牌形象和吸引觀眾的視覺解決方案。
...
DBS DigiBank CN重新思考並重新設計，讓您享受更快速、更方便的銀行服務。
...
**職責：**
- 與後端工程師團隊合作開發自動補充功能，當用戶的餘額低於某個金額時，自動從用戶的信用卡或借記卡中補充資金。
- 協作監控來自Azure EventHub的支付後事件，確保無縫整合，並在用戶設置自動補充配置時檢查補充。
...
- 管理從本地開發到UAT測試和生產發布的整個開發生命週期，使用Copilot執行根本原因分析、生成Python腳本和記錄約50份技術指南，這些指南成為團隊的關鍵參考資料。
- 使用AI工具如Copilot、性能分析工具YourKit和系統化測試開發創新的銀行技術解決方案，同時作為自主AI代理，分析項目架構、與團隊協作並通過全面的日誌記錄和文檔改進。
