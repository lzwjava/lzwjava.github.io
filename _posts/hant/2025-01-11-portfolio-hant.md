...
[開源於GitHub](https://github.com/lzwjava/flower-recognition)，33次提交。
...
[開源於GitHub](https://github.com/lzwjava/leanchat-android)，412次提交。
...
[開源於GitHub](https://github.com/lzwjava/leanchat-ios)，446次提交。
...
參與了LeanCloud的Java SDK和Objective-C SDK的開發，為開發者提供了工具，以便輕鬆地將LeanCloud服務整合到他們的應用程式中。
...
創建了一個Xcode插件，專為在當前存儲庫中無縫導航到GitHub的關鍵功能而設計。該插件允許用戶快速訪問GitHub歷史記錄、責備、拉取請求、問題和通知。
...
開發了江蘇電視台超級大腦節目的微信小程序，為用戶提供互動式謎題。主持人通過口播廣播引導用戶，呈現特定的技術挑戰。
...
- 開發後端服務和管理面板前端。
- 設計並實現即時問答遊戲功能。
- 貢獻了通過SEI（增強信息）同步直播流與遊戲事件的技術解決方案。
...
ShowMeBug是一個支持實際編程的技術能力評估平台，可高效、準確地評估和招聘技術人才。
...
為DBS Client Connect貢獻，這是一個基於AI和數據的客戶關係管理平台，專注於股票交易微服務。

**使用技術：** Java, Spring Cloud, Jenkins, Pivotal Cloud Foundry

**職責：**
- 開發股票交易的後端服務。創建股票顯示、客戶顯示、交易前檢查和訂單下單的功能。
...
DBS DigiBank CN重新思考並重新設計，讓您享受更快捷、更方便的移動銀行體驗。

為DBS DigiBank CN貢獻，專注於共同基金微服務的後端開發，作為協作團隊的一員。

**使用技術：** Java, Spring Cloud, Jenkins, Pivotal Cloud Foundry, Kibana

**職責：**
- 增強共同基金的訂閱和贖回功能，提高用戶體驗和系統可靠性。
- 修復結構化投資產品、投資組合和交易列表相關微服務的漏洞，並增強代碼，以提高系統穩定性和準確性。
...
- 管理從本地開發到UAT測試和生產發布的整個開發生命週期，使用Copilot執行任務，如根本原因分析、生成Python腳本和記錄約50份技術指南，這些指南成為團隊成員的關鍵參考。
