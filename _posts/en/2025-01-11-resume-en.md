...
- Managed the full development lifecycle from local development to UAT testing, production releases, and troubleshooting issues such as deadlocks and IBM Db2 procedures. Automated repetitive tasks using Python scripts and documented over 100 technical guides, some of which became key references for teammates facing similar challenges.  
