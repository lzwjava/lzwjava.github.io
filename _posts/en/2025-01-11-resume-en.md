...
- Under the constrained environment of banking, I tried a lot of new ways to do things. This included intermittently using VSCode or IntelliJ's Copilot plugin to leverage the power of the internal AI assitant, introducing the YourKit Java Profiler to help measure software performance, utilizing four database tools or creating scripts to perform certain tasks in the best way, and accumulating hundreds of logs in a directory as the journey continued, to help with later analysis.
