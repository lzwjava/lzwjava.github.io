...
* Backend Engineer outsourced to HSBC Bank (under TEKsystems/Allegis Group), developing and optimizing backend systems for the Finance Transformation Platform in HSBC’s Enterprise Technology Department.
* Maintained features for financial data processing (import, validation, export) and enhanced submission/approval workflows for new financial headers, leveraging knowledge of accounting, ledger, and banking systems.
* Managed full development lifecycle: local development, UAT testing, production releases, troubleshooting (deadlocks, IBM Db2 procedures), and fixing defects. Automated tasks with Python scripts and documented 100+ technical guides, with certain documents becoming valuable references for team members facing similar challenges.
* The role involved working with technologies such as Java, Spring Boot, IBM Db2, multithreading, Maven, Nexus, Angular, and Python, along with tools including Windows, Control-M, IBM WebSphere Application Server, and Copilot.
