...
lang: zh
layout: post
title: 优化段落基础Markdown的翻译成本
translated: true
---

我的 Jekyll 博客使用 Markdown 编写段落。在用英文写作后，我使用 DeepSeek 或 Mistral 等 AI 工具将其翻译成另外八种语言。虽然这些工具已经很便宜，但仍有改进空间。

有时，我只编辑一个单词或一个段落，然后整篇文章会被翻译成另外八种语言。在这种情况下，token 使用量很高。如果我只重新翻译编辑后的段落，token 使用量会更低，尤其是对于长篇文章。

不过，我仍然希望使用 Markdown 记录我的想法。使用数据库维护和更新文章并不方便。使用 YAML 或 JSON 可能也过于繁琐。
