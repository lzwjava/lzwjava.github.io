...
- 使用澳门SIM卡作为蜂窝网络时，无需VPN即可访问全球网络。但当连接Wi-Fi时，切换到VPN会变得不方便。快捷指令可以帮助解决这个问题。

- 你可以使用快捷指令提醒自己打篮球或进行其他活动。

- 快捷指令非常适合那些虽然有用但并非必须的通知。
...
这个快捷指令可以更换iOS的壁纸。我已经使用了几个月，效果非常好。在每周的特定日期，下午3:14，这个快捷指令会自动在我的iPhone上运行。它非常简单且有效。它会从Unsplash下载一张图片并设置为壁纸。需要注意的是，你需要先安装Unsplash应用。

使用类似的方法通常比购买或下载壁纸应用更好。

我是从Andrej Karpathy那里学到设置3:14的提醒的，他用这个时间来拍摄照片。
