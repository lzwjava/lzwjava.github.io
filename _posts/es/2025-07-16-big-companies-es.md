...
Las grandes empresas son como grandes programas. Para una gran empresa con 100,000 empleados y 50,000 contratistas, son como un gran programa con 200,000 métodos.
...
Las grandes empresas tienen tantos procedimientos y procesos porque no confían en sus empleados o contratistas. Por lo tanto, necesitan verificar mucho y controlar mucho.

Una cosa sobre las grandes empresas es que les da miedo cometer errores. Una razón es que han crecido tanto hasta valer 300 mil millones o 1 billón de dólares; deben haber cometido toneladas de errores y haber crecido a partir de eso. Sin embargo, cuando tienen éxito, son reacios a tomar riesgos y cometer errores nuevamente.

Es como un gran programa que no le gusta tener errores y trata de eliminar cualquier error, especialmente errores de seguridad, particularmente en grandes bancos.

Las startups son rápidas, pero los recursos de una startup son mucho menores, y la marca de una startup no está establecida; no tienen la confianza de las grandes empresas.

En China, los jóvenes talentosos aún quieren ir a grandes empresas después de graduarse y luchan por lograrlo. En Silicon Valley, hay tantas startups, algunas de las cuales tienen éxito desde el principio con solo ideas.

Algunas empresas duran 20 años y aún luchan, probablemente han sido eliminadas del mercado de valores, y algunas empresas valen 5 mil millones o 10 mil millones de dólares solo cuando tienen unos pocos meses de antigüedad.

Se dice que [el laboratorio de máquinas pensantes de Mira Murati vale $12 mil millones en la ronda de semillas](https://techcrunch.com/2025/07/15/mira-muratis-thinking-machines-lab-is-worth-12b-in-seed-round/). Y [la superinteligencia segura de Ilya Sutskever recaudó $2 mil millones a un valor de $32 mil millones](https://techcrunch.com/2025/04/12/openai-co-founder-ilya-sutskevers-safe-superintelligence-reportedly-valued-at-32b/).
...
En mi startup en solitario, solo necesito usar 1 minuto para implementar mi servidor backend y 5 minutos para corregir un error menor e implementarlo. Es directo y rápido. Para las grandes empresas, toma 1 semana preparar la solicitud de implementación, obtener aprobaciones de los gerentes, hacer la implementación con el equipo de TI y hacer verificaciones de salud.

Aunque el tiempo real invertido pueda ser de 8 horas, si lo medimos, sigue siendo 1 semana desde la preparación de la implementación hasta la verificación final de salud.

Para corregir un error menor e implementarlo, toma dos semanas hacerlo. Obtienes el ticket para investigar, hacer análisis y pruebas, luego revisar, fusionar el código, informar a los equipos de prueba para que lo prueben y luego implementarlo.

Las grandes empresas les gusta imponer sus políticas en todos los equipos o proyectos. Porque para una gran empresa con 200,000 personas, esas políticas o procesos internos que solo se aplican a 10,000 personas no tienen mucho significado o resultado. Para algunos procesos internos, las grandes empresas necesitan invertir personas o dinero para desarrollar herramientas que los respalden. Por lo tanto, si solo sirve a una pequeña proporción del personal, el retorno no justifica la inversión.
...
En un caso notable dentro de una gran corporación, se observó que no hubo consecuencias significativas para los involucrados. Algunos gerentes senior y muchos de los empleados recién contratados fueron despedidos. No está claro si esto estuvo relacionado con una contratación rápida y sustancial.
...
Parecía que no se aprendió ninguna lección valiosa de esta experiencia. Inicialmente, un grupo de gerentes decidió una estrategia de contratación rápida y extensa, que en ese momento parecía innecesaria. Culpar a todo el grupo de gerentes no era factible, ni era práctico despedir solo a aquellos que llevaban poco tiempo en la empresa, especialmente cuando otros gerentes y líderes técnicos habían sido parte del equipo durante seis a ocho años.

El director general no ganó mucha perspectiva de la situación, ya que este era solo uno de tres departamentos bajo su supervisión y su compensación no cambió. Incluso dentro del equipo, aquellos que no fueron directamente responsables no pudieron aprender de la experiencia, lo que refleja los comentarios de Steve Jobs sobre la consultoría. Por lo tanto, nadie absorbió la lección necesaria para formar un equipo excepcional capaz de entregar resultados sobresalientes para los usuarios.
...
Paul Graham escribió un ensayo antes, [La contratación está obsoleta](https://paulgraham.com/hiring.html).

Pero, ¿qué hacen bien las grandes empresas? Una es el largo plazo. Tienden a hacer las cosas a largo plazo. Para algunas buenas grandes empresas, sus diseños de proyectos son bastante buenos; usan microservicios para evitar el error de convertirse en un gran programa monolítico después de una década. Y tienen equipos de gobierno para hacer algunos marcos fundamentales y unificar las prácticas de desarrollo para todo el equipo.

Los procesos o procedimientos no son inherentemente malos. Pero a menudo hacen las cosas complicadas y lentas. No encontramos desagradable el formato de código unificado de Java porque hay un complemento Spotless o Checkstyle para ayudar. Estos complementos tienen un buen diseño y son fáciles de usar.

Otra cosa es que las grandes empresas tienden a hacer algunas herramientas o proyectos para uso interno, para los oficiales de primera línea. Pero esa base de usuarios es solo de cientos o 10,000. Esa base de usuarios es muy limitada.
...
Pero como el AI, en realidad, muchos usuarios están bien con productos que no son tan estables al principio, como DeepSeek. Sabemos que DeepSeek tuvo muchas caídas alrededor de febrero y marzo de 2025 cuando ganó mucha atención. Pero después de un tiempo, se vuelve mejor y no parece que los usuarios tengan muchos problemas con eso.
...
¿Cómo sobrevivir en grandes empresas? Una es hacer más, hablar menos. Eso es lo que me dijo mi gerente de entrega en un proveedor de outsourcing.
