...
Para las startups, parece un caso mucho mejor. Porque realmente es serio. Algunos de los fundadores que pierden o fracasan realmente lo pasan muy mal, especialmente los honestos.
...
En cuanto a la estabilidad, veo que las grandes empresas tienden a tener múltiples miembros del equipo trabajando en tareas duplicadas. Por ejemplo, para la tarea A y la tarea B, no asignan a dos ingenieros del equipo para trabajar por separado en la tarea A y la tarea B. En su lugar, hacen que ambos trabajen en partes de la tarea A y la tarea B para que estos dos ingenieros sepan lo que está haciendo el otro. Esto hace que el equipo sea más estable, ya que evita una situación en la que solo una persona sabe mucho sobre grandes partes del código y ha estado trabajando en eso durante varios años sin colaboración. Luego, si esa persona deja la empresa, nadie más puede trabajar en ello.
