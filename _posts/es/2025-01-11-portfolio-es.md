...
Esta colección de software representa los diversos proyectos en los que he tenido el privilegio de trabajar a lo largo de los años, en colaboración con diversas empresas y socios destacados.

Estoy agradecido por las oportunidades y experiencias que estas colaboraciones han proporcionado, y espero continuar contribuyendo con mis habilidades y experiencia a futuros emprendimientos.
...
El rango de problemas de algoritmos que he resuelto abarca diversas áreas, incluyendo estructuras de datos, gráficos, matemáticas, procesamiento de cadenas, geometría y varios otros temas avanzados o especializados.
...
- Implementé características para mejorar el vocabulario y la comprensión a través de contenido interactivo.

**Logros:** Ganó el Tercer Premio en el Hackathon de Nube AVOS 2014.

[SegmentFault: Revisión de los logros del Hackathon de Nube AVOS 2014](https://segmentfault.com/a/1190000000427302)

## Bjfu Assistant, Android, 2014.1 - 2014.6

Una aplicación Android de asistente universitario que integra funciones como verificar calificaciones y participar en foros de exalumnos.

**Tecnologías Utilizadas:** Android SDK, Java

**Responsabilidades:**
- Desarrollé las funcionalidades principales como la verificación de calificaciones y la participación en foros.
...
LeanChat es una aplicación de chat que incluye funciones como gestión de amigos, gestión de grupos, mensajería basada en ubicación, personas cercanas, perfiles personales y funciones de inicio de sesión/registro, todas utilizando plenamente las capacidades de almacenamiento y comunicación de LeanCloud.

**Tecnologías Utilizadas:** Android SDK, Java, LeanCloud

**Responsabilidades:**
- Desarrollé las funciones de gestión de amigos, gestión de grupos y mensajería basada en ubicación.
...
- Aseguré la integración fluida de los servicios de LeanCloud como almacenamiento de objetos, almacenamiento de archivos y mensajería.
...
Desarrollé un complemento de Chrome que cierra automáticamente las pestañas más antiguas cuando el navegador se llena de demasiadas pestañas, mejorando el rendimiento del navegador y la experiencia del usuario.
...
**Tecnologías Utilizadas:** Objective-C, API de complementos de Xcode
...
- Manejé la gestión de usuarios, el proceso de envío y revisión de código, sistemas de notificación, integración de pagos y gestión de eventos/talleres.
...
Fun Live es una plataforma de transmisión en vivo de conocimiento donde los usuarios pueden participar en diversas conferencias de conocimiento como programación o diseño. Los usuarios pueden pagar tarifas para asistir a sesiones en vivo o recompensar al conferencista.
...
- Implementé las funcionalidades de registro de usuarios, pago y notificaciones.
...
Mianbao Live es un proveedor de soluciones de monetización de contenido y economía social todo en uno.
...
- Implementé componentes frontend utilizando el marco de Programa Mini de WeChat.
...
## Square Root Inc - 50 proyectos misceláneos, Gestión de Proyectos & Algunos Desarrollos de Software, 2018.1 - 2019.12
...
- Contribuí al desarrollo de software para diversos proyectos.
...
<p>(Responsable de Gestión de Proyectos)</p>

</div>

## ShowMeBug - Entrada de WeChat Empresarial, Full Stack, 2021.7 - 2021.9

ShowMeBug es una plataforma de evaluación de competencia tecnológica que admite programación práctica, permitiendo una evaluación y contratación eficientes y precisas de talentos técnicos.

Integré ShowMeBug con WeChat Empresarial, permitiendo un acceso sin problemas a las herramientas de entrevista técnica dentro del ecosistema de WeChat Empresarial.

**Tecnologías Utilizadas:** Ruby, PostgreSQL, SDK de WeChat, Docker

**Responsabilidades:**
- Desarrollé características de integración para inicio de sesión y acceso a entrevistas.
...
LvchenSign se especializa en la producción de señalización publicitaria para diversos negocios y eventos. Con un enfoque en la calidad y la creatividad, se esfuerza por ofrecer soluciones visuales impactantes que eleven las marcas y cautiven a las audiencias.
...
- Creé una interfaz intuitiva y fácil de usar para mostrar productos.

Open sourced at [GitHub](https://github.com/lzwjava/lvchensign), 40 commits. Página en línea en [lvchesign.com](http://lvchensign.com).
...
**Responsabilidades:**
- Desarrollé servicios backend para trading de acciones. Creé funcionalidades para la visualización de acciones, visualización de clientes, verificaciones previas al comercio y colocación de órdenes.
...
Contribuí a DBS DigiBank CN, centrado en el desarrollo backend para microservicios de fondos mutuos como parte de un equipo colaborativo.
...
- Realicé pruebas de rendimiento y analicé registros para generar informes de QPS, colaborando con miembros del equipo para optimizar el rendimiento.
- Desarrollé una herramienta para automatizar la generación de pruebas para la herramienta de pruebas Karate, lo que simplificó el proceso de pruebas y mejoró la cobertura de pruebas.
...
- Monitoreé colaborativamente eventos post-pago de Azure EventHub, asegurando una integración fluida y verificando recargas cada vez que un usuario configuró su configuración de auto recarga.
...
**Tecnologías Utilizadas:** Java, Spring Boot, IBM Db2, Multihilo, Maven, Nexus, Angular, Python, Windows, Control-M, IBM WebSphere Application Server, Copilot, YourKit
...
- Mantenido características para el procesamiento de datos financieros, incluyendo importación, validación y exportación, mientras mejoraba los flujos de trabajo de envío y aprobación para nuevos encabezados financieros, aprovechando mi experiencia en contabilidad, libros mayores y sistemas bancarios.
- Gestioné el ciclo de desarrollo completo desde el desarrollo local hasta las pruebas de UAT y las versiones de producción, utilizando Copilot para tareas como el análisis de causas raíz, la generación de scripts de Python y la documentación de aproximadamente 50 guías técnicas que se convirtieron en referencias clave para mis compañeros de equipo.
...
- Exploré la implementación de un agente de software de IA en un proyecto financiero importante utilizando AspectJ para recopilar registros extensos y convertir estados de depuración a texto, proporcionando contexto para chatbots de IA.