...
Una aplicación Android de asistente del campus que integra funciones como la verificación de calificaciones y la participación en foros de exalumnos.
...
- Aseguré la integración sin problemas de los servicios de LeanCloud como el almacenamiento de objetos, el almacenamiento de archivos y la mensajería.
...
## El programa WeChat Mini para el programa Super Brain, Full Stack, 2018.3 - 2018.4
...
Integra ShowMeBug con Enterprise WeChat, permitiendo un acceso sin problemas a las herramientas de entrevista técnica dentro del ecosistema de Enterprise WeChat.
...
LvchenSign se especializa en la producción de señalización publicitaria para diversos negocios y eventos. Con un enfoque en la calidad y la creatividad, se esfuerzan por ofrecer soluciones visuales impactantes que eleven las marcas y cautiven a las audiencias.
...
- Solucioné errores y mejoré el código para los microservicios relacionados con productos de inversión estructurados, cartera de inversión y lista de transacciones, contribuyendo a la estabilidad y precisión general del sistema.
