...
[SegmentFault: Revisión de los logros del Hackathon de AVOS Cloud 2014](https://segmentfault.com/a/1190000000427302)

## Bjfu Assistant, Android, 2014.1 - 2014.6

Una aplicación Android de asistencia universitaria que integra funciones como la verificación de calificaciones y la participación en foros de exalumnos.
...
Creé un complemento de Xcode diseñado para la navegación fluida a las funcionalidades clave de GitHub dentro del repositorio actual. El complemento permite a los usuarios acceder rápidamente al Historial de GitHub, Culpa, Solicitudes de Extracción, Problemas y Notificaciones.
...
CodeReview es una plataforma profesional para la revisión, comunicación y compartición de código. Los ingenieros pueden enviar su código para su revisión por expertos y mejorar la calidad de su código.
...
ShowMeBug es una plataforma de evaluación de competencia tecnológica que admite programación práctica, permitiendo una evaluación y contratación eficiente y precisa de talentos técnicos.

Integramos ShowMeBug con WeChat Empresarial, permitiendo un acceso sin problemas a las herramientas de entrevista técnica dentro del ecosistema de WeChat Empresarial.
...
LvchenSign se especializa en la producción de señalización publicitaria para diversos negocios y eventos. Con un enfoque en la calidad y la creatividad, nos esforzamos por ofrecer soluciones visuales impactantes que eleven las marcas y cautiven a las audiencias.
...
Contribuí a DBS Client Connect, una plataforma de gestión de relaciones con clientes impulsada por IA y datos, centrada en los microservicios de trading de acciones.
...
- Monitoreé colaborativamente eventos posteriores al pago desde Azure EventHub, asegurando una integración fluida y verificando recargas cada vez que un usuario configuró su configuración de auto recarga.
...
**Responsabilidades:**
- Desarrollé y optimicé sistemas backend para la Plataforma de Transformación Financiera en el Departamento de Tecnología Empresarial de HSBC como Ingeniero Backend externalizado bajo TEKsystems.
