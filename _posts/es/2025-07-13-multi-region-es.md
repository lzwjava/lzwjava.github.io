...
Probablemente esto no sea la forma correcta de hacerlo. En los primeros años, parece simple o factible. Pero después de una década, sabrán que es muy doloroso. El costo de mantenimiento o sincronización, el costo de pruebas—hay toneladas de esfuerzos duplicados.

Sin embargo, para Facebook, Google o Apple Pay, es un poco simple. Alguien puede decir que no son aplicaciones financieras; tienen algunas reglas de cumplimiento que deben seguir. No es cierto. El cumplimiento a menudo significa el servidor de base de datos, o la base de datos, o algunos datos que los departamentos gubernamentales quieren verificar o que las empresas de auditoría deben auditar.
...
Probablemente haya algunos proyectos en grandes empresas tecnológicas que usan continentes para separar, como Asia y la región del Pacífico, América del Norte. Para estos también.
...
El mundo se está volviendo más conectado. No importa qué país o región nos dirijamos inicialmente, también debemos considerar otras regiones. Es mejor hacerlo bien desde el principio. Para las empresas internacionales establecidas, es aconsejable desarrollar productos de software para al menos dos países o regiones desde el principio. Mantén esta mentalidad multi-regional desde el principio. Si tenemos más recursos de ingeniería, podemos apoyar más países o regiones.