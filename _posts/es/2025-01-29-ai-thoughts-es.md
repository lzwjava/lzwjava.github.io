...
- Por el contrario, es poco probable que los LLMs revolucionen tecnologías como Git, Linux, ffmpeg, teléfonos móviles, hardware, navegadores, sistemas operativos o llamadas de voz y video. Estas tecnologías están centradas en código, y su código no es fácilmente generable por IA, a diferencia de herramientas de prueba de APIs como Postman.
...
- La razón por la que prefiero usar Ubuntu desde el lanzamiento de los LLM es que las aplicaciones coloridas y ricas de macOS me resultan menos atractivas. Prefiero escribir mis programas y hacer todo a través de la terminal y texto.
