...
- Los LLMs cambiarán primero las aplicaciones relacionadas con texto, como Google, motores de búsqueda, editores de texto, herramientas de escritura, Quizlet, Zendesk, DeepL, Medium, WordPress, Trello, Asana, Gmail, GitHub, Goodreads, Duolingo y Feedly.
...
- La razón por la que prefiero usar Ubuntu desde el lanzamiento de los LLM es que las aplicaciones coloridas y variadas de macOS me resultan menos atractivas. Prefiero escribir mis propios programas y hacer todo a través de la terminal y texto.
