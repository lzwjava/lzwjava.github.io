...
* Al usar la API de Deepseek o Mistral para traducir títulos con indicaciones como `Eres un traductor profesional. Estás traduciendo un archivo de markdown para un blog de Jekyll del inglés al chino. {texto}`, puede llevar a traducciones incorrectas. Además del texto que proporcionas, la salida a menudo incluye traducción excesiva.
