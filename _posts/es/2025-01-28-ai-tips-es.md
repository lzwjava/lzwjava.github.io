...
* Los libros están siendo cada vez menos útiles. Usa chatbots de IA para leer un libro; pueden proporcionarte el Capítulo 1 o el Capítulo 2, un resumen o una introducción de un libro.
...
* Es mejor dividir un script de Python grande en scripts más pequeños, ya que esto usa menos tokens y permite que los modelos de lenguaje grandes los manejen de manera más efectiva.
