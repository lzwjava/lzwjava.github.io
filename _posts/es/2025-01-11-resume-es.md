...
- Buen entendimiento de HTML, CSS, APIs de navegador, JavaScript, Vue.js, React, Angular y desarrollo de iOS/Android. Familiar con Java, Spring, Spring Boot, MySQL, Redis, APIs, redes, contenedores y sistemas distribuidos. Familiar con módulos de registro, bases de datos y microservicios en Alibaba Cloud, AWS y Azure.
...
- Investigador autodidacta con tres artículos de estilo académico sobre la reversión de la miopía y la restauración de la visión natural, inspirados en los trabajos de Yin Wang y Todd Becker, respaldados por tres años de experimentación.
...
- Intentó implementar un agente de software de IA en un gran proyecto financiero utilizando AspectJ para recopilar toneladas de registros y convertir los estados de depuración en texto, proporcionando contexto para los chatbots de IA.
...
- Mantenimiento de un blog técnico con 431 publicaciones originales. Utilizó modelos de lenguaje grandes para traducir el contenido a 9 idiomas, proporcionar audio de texto a voz, admitir formatos PDF y EPUB, integrarse con los flujos de trabajo de GitHub y usar LaTeX para escribir artículos o crear un currículum. Otras tecnologías empleadas incluyen Python, Jekyll, Deepseek y Mistral. El sitio web es https://lzwjava.github.io.
...
- Beyondsoft Consulting es una empresa líder en TI y consultoría empresarial. DBS Bank es el banco más grande del sudeste asiático por activos y entre los más grandes de Asia. Contratación con Beyondsoft, asignado a trabajar para DBS Bank y contribuyó a los proyectos DBS Client Connect y DBS DigiBank CN.
...
- Actualmente se prepara para 7 cursos como Redes de Computación, Tecnología Electrónica Básica (III), Tecnología de Microcomputadoras e Interfaz, Pensamiento de Mao Zedong y Teoría del Socialismo con Características Chinas, Cultivo Ideológico y Moral y Estado de Derecho, Chino Universitario y Álgebra Lineal.
...
- DBS Client Connect (2021.12 - 2022.6) Participó en el desarrollo backend de comercio de acciones. Usó tecnologías como Java, Spring Cloud y Pivotal Cloud Foundry.
- ShowMeBug (2021.7 - 2021.9) Responsable de la integración entre la plataforma y WeChat Empresarial, incluyendo inicio de sesión y acceso fácil a entrevistas. Usó tecnologías como Ruby on Rails, PostgreSQL y SDK de WeChat.
...
- Programa de TV Super Cerebro WeChat Mini Program (2018.2 - 2018.3) Responsable del desarrollo backend y frontend. Usó tecnologías como Java, Spring, JavaScript, HTML y AliCloud.
- Chongding Conference (2017.9 - 2018.1) Responsable de algo de desarrollo backend y frontend del panel de administración para una aplicación de trivia en vivo. Usó tecnologías como Java, Spring, WebSocket y Netty.
...
A continuación se detallan las herramientas que me ayudan a acumular las habilidades anteriores, además de otras herramientas interesantes. Todavía estoy usando algunas de ellas y puedo aprenderlas en unos pocos días para usar las demás.
