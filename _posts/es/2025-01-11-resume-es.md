...
- Amante de los viajes y maestro de road trips. Ha estado en los EE. UU. dos veces, así como en Hong Kong y Macao, y en la mitad de China. Tomó cursos de inglés en línea con 60 profesores de inglés filipinos, y algunos profesores africanos o europeos también.
...
- Mantuvo características para el procesamiento de datos financieros, incluyendo importación, validación y exportación, mientras mejoraba los flujos de trabajo de presentación y aprobación para nuevos encabezados financieros. Aprovechó su experiencia en sistemas contables, libros mayores y bancarios.
...
- En el proyecto DBS Client Connect, contribuyó al desarrollo del microservicio de comercio de acciones. Las responsabilidades incluían crear funcionalidades para la visualización de acciones, visualización de clientes, verificaciones previas al comercio y la colocación de órdenes reales de comercio de acciones. Integró APIs de Avaloq para mejorar la infraestructura subyacente y mejoró la experiencia del usuario implementando un algoritmo de distancia de edición para refinar las búsquedas de códigos de acciones.
...
- Completó varios proyectos de software como freelancer, Desarrollo de Sitio Web de Señales LED, Integración de WeChat Empresarial para ShowMeBug, Web Scraper para Recopilación de Datos Comerciales, herramienta de libros electrónicos mathjax2mobi.
...
- Clasificado entre los 300 mejores en la NOIP de Guangdong (Olimpiada Nacional de Informática en Provincias) de 2011.
...
- Matemáticas: Cálculo, Álgebra Lineal, Matemática Discreta, LaTeX
