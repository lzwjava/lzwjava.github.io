...
- Mantenimiento de un blog técnico con 431 publicaciones originales. Utilizó modelos de lenguaje grandes para traducir el contenido a 9 idiomas, proporcionar audio de texto a voz, admitir formatos PDF y EPUB, integrarse con flujos de trabajo de GitHub y usar LaTeX para escribir artículos o crear un currículum. Otras tecnologías empleadas incluyen Python, Jekyll, Deepseek y Mistral. El sitio web es https://lzwjava.github.io.
...
- Contribuyó activamente a la migración a la nube tras participar en la capacitación de AWS de la empresa. Refactorizó APIs para utilizar enrutamiento basado en encabezados de solicitud, garantizó acceso seguro y configuraciones de bases de datos, y participó en el despliegue de microservicios en la nueva infraestructura en la nube.
...
- Como emprendedor en solitario, codifiqué durante el día y gané usuarios por la noche; todo fue directo con una burocracia mínima. Este fue mi pico de rendimiento. Registré la empresa, me reuní con inversores para asegurar una inversión de medio millón de CNY, manejé cambios de acciones, asistí a otras conferencias de ingeniería para contactar a posibles conferencistas y construí 10 grupos de WeChat con alrededor de 500 personas cada uno. Las alturas y las bajas fueron intensas y emocionantes.
...
- Clasificado en el top 300 en la Guangdong NOIP (Olimpiada Nacional de Informática en Provincias) de 2011.
...
- Programa de TV Super Cerebro WeChat Mini Program (2018.2 - 2018.3) Responsable del desarrollo backend y frontend. Utilizó stacks tecnológicos como Java, Spring, JavaScript, HTML y AliCloud.
...
- Li, Zhiwei. (Nov 2024). *Restauración Natural de la Visión: El Principio de 'Justo Bastante Claro'.* https://lzwjava.github.io/barely-clear-en.
