...
lang: de
layout: post
title: Wie ich den KQV-Mechanismus in Transformern gelernt habe
translated: true
---
...
Das habe ich etwa Anfang Juni 2025 verstanden. Ich habe es erstmals Ende 2023 gelernt. Damals habe ich Artikel wie [The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/) gelesen, aber ich habe nicht viel verstanden.
...
Ein Grund dafür ist, dass es im Zeitalter der KI leichter ist zu lernen, weil man in jedes Detail oder jeden Aspekt eintauchen kann, um Zweifel zu klären. Es gibt auch mehr verwandte KI-Videos. Wichtiger ist, dass man sieht, wie viele Menschen lernen und Projekte darauf aufbauen, wie z. B. [llama.cpp](https://github.com/ggml-org/llama.cpp).
