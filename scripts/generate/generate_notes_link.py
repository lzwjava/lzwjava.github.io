...
These {len(sorted_links)} notes were generated by AI chatbots using prompts I wrote basically. I use them to learn, explore topics, and build comprehensive guides. Together, these notes capture many aspects of my thinking and curiosity. I sometimes share them with friends to spark further discussion.
