...
These {len(sorted_links)} notes were generated by AI chatbots using prompts I wrote. I use them to learn, explore topics, and build comprehensive guides. Recently, I added model information to compare responses across different LLMs, which also reflects what I’ve been interested in over recent months and years. Together, these notes capture many aspects of my thinking and curiosity. I sometimes share them with friends to spark further discussion.
