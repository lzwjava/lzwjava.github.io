...
def explore_photos_database(photos_library_path):
    ...
    try:
        ...
        video_related_tables = [table for table in tables if "VIDEO" in table.upper() or "ASSET" in table.upper()]
        ...
        if "ZADDITIONALASSETATTRIBUTES" in video_related_tables:
            ...
            time_columns = [col for col in columns if "DATE" in col.upper() or "CREATION" in col.upper()]
