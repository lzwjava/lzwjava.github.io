...
def translate_text_with_cache(text, target_language, type="content", model="deepseek", front_matter_prompt=None, original_lang=None):
    ...
    translated_text = translate_text(text, target_language, type, model, front_matter_prompt, original_lang)
...
if __name__ == "__main__":
    ...
    text = translate_text_with_cache('Hi, it is sunny today. Hahaa...', 'ja', model='mistral', original_lang='en')
