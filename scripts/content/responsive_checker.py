        ...
        for img_path in images:
            ...
            try:
                ...
                with Image.open(full_img_path) as img:
                    ...
                    if width < height:
                        print(f"Image {img_path} in {file_path} should be responsive. Dimensions: {width}x{height}")
...
if __name__ == "__main__":
    directory = "/Users/lzwjava/projects/lzwjava.github.io/_posts"  # Adjust this path as needed
