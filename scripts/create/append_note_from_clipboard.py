...
def main():
    parser = argparse.ArgumentParser(description="Append clipboard content to a note file.")
    parser.add_argument('note_path', help="Path to the note file (e.g., ./notes/xxx.md)")
