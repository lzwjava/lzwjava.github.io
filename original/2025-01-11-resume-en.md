...
- Under the constrained environment of banking, I explored numerous new methods to conduct operations responsibly. This included intermittently using VSCode or IntelliJ's Copilot plugin to leverage the power of the internal AI assitant, introducing the YourKit Java Profiler to help measure software performance and accumulating hundreds of logs in a directory as the journey continued, to help with later analysis.
