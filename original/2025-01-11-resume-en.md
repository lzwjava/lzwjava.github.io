...
* This role involves developing and optimizing backend systems within HSBC’s Enterprise Technology Department, utilizing technologies such as Spring Boot, Java, multithreading, networking, Maven, Nexus, and development in Windows, Eclipse, and IBM WebSphere Application Server.
...
* Currently preparing for 7 courses such as Computer Networks, Basic Electronic Technology (III), Microcomputer and Interface Technology, College Chinese, Mao Zedong Thought and Theory of Socialism with Chinese Characteristics, and Ideological and Moral Cultivation and Rule of Law and Linear Algebra.
