...
* Responsible for developing and optimizing backend systems within HSBC's Enterprise Technology Department, specifically for the Finance Transformation Platform. This role requires business knowledge of accounting, ledger, banking and financial reporting. I maintained code for importing, validating, exporting, and listing financial data, and adjusted the submission and approval procedures for new types of financial headers.
* Involved in the whole lifecycle of feature development, from local development, UAT testing, and production releasing. My responsibilities ranged from investigating deadlock reasons to resolving IBM DB2 stored procedure calling issues, fixing data or code logic reported by the testing team, heavily utilizing Copilot, and writing Python scripts to help testing and beyond. Organized and posted over one hundred technology documents or tool guides, some of which caught the attention of the team and helped them solve same problems.
