...
When I worked as a contractor for a Singaporean bank, we used Pivotal Cloud Foundry to serve the microservices. At that time, I started to accumulate logs when working in the company.
